    ...
    <div class="main">
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <?php
                    ...
                    echo'</select>'
                ?>
                <input type="text" name="rno" placeholder="College USN">
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <input type="text" name="rn" placeholder="College USN">
                <input type="text" name="p1" id="" placeholder="Database Management systems - Marks">
                <input type="text" name="p2" id="" placeholder="Operating System - Marks">
                <input type="text" name="p3" id="" placeholder="Python programming - Marks">
                <input type="text" name="p4" id="" placeholder="Mathematics - Marks">
                <input type="text" name="p5" id="" placeholder="Introduction to AI&ML - Marks">
