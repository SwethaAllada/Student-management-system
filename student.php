        ...
        <div class="main2">
            <table>
                ...
                <tbody>
                  <tr>
                    <td> 1 </td>
                    <td colspan="10">Database Management systems </td>
                    <td> <?php echo '<p>'.$p1.' / 100</p>';?> </td>
                  </tr>
                
                  <tr>
                    <td> 2 </td>
                    <td colspan="10">Operating System </td>
                    <td> <?php echo '<p>'.$p2.' / 100</p>';?></td>
                  </tr>
            
                  <tr>
                    <td> 3 </td>
                    <td colspan="10">Python programming </td>
                  ...
                  <tr>
                    <td> 5 </td>
                    <td colspan="10">Introduction to AI&ML </td>
